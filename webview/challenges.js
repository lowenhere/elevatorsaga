...
var challenges = [
    {options: {floorCount: 2, elevatorCount: 8, spawnRate: 0.3}, condition: requireUserCountWithinTime(1, 60)},
    {options: {floorCount: 5, elevatorCount: 8, spawnRate: 1.5, elevatorCapacities: [6,8]}, condition: requireDemo()},
